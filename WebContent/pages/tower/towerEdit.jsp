...
<div class="col-md-12 col-xs-12 topDiv" >
				...
				<div class="pull-right">
					<button class="btn btn-success" id="btn_apply_save" onclick="saveTower()"><i class="fa fa-check-square-o"></i>&nbsp;&nbsp;提&nbsp;交</button>
...
<script type="text/javascript" src="<%=basePath%>pages/tower/towerEdit.js"></script>
