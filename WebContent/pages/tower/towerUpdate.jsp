...
<div class="col-md-12 col-xs-12 topDiv" >
				...
				<div class="pull-right">
						<button id="" onclick="updateTower()" class="btn btn-success">
								<i class="fa fa-check-square-o"></i>&nbsp;&nbsp;提&nbsp;交
						</button>
...
<script type="text/javascript" src="<%=basePath%>pages/tower/towerUpdate.js"></script>
