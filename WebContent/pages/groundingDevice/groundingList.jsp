	...
	<div class="container">
		<div class="row row_serch">
			...
			<div class="col-md-12 col-xs-12 data-div">
				<table class="table table-hover table-bordered" id="grounding_table">
					<thead>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/pages/groundingDevice/groundingList.js"></script>
<script type="text/javascript">
	var path="<%=request.getContextPath()%>";
	var groundingList = new groundingList();
</script>
</html>