...
<!-- 自定义css -->
<link rel="stylesheet" href="<%=basePath %>pages/material/partsExplain.css">
<body>
...
<div class="text-center"><h1>材料</h1>
</div>
<table id="materialTable">
<tr id=""><td style="width: 50px">序号</td><td style="width: 200px">材料类型</td><td style="width: 200px">型号</td><td style="width: 100px">单位</td><td style="width: 100px">数量</td><td style="width: 200px">备注</td></tr>
<tr id="materialTr"></tr>

<tr style="height: 18px"></tr>
<tr><td rowspan="2" colspan="6"   style="border: 0px solid black;"></td><td rowspan="2" style="width: 100px">说明页</td><td style="width: 100px">图     号</td><td style="width: 100px">图纸级别</td></tr>
<tr><td><span id="pageCode"></span></td><td>3</td></tr>

</table>
<div class="pull-right">
<table id="explainTable">
<!-- <tr style="text-align:center;"><td colspan="10"><h1>材料</h1></td></tr>
...
<td style="border: 1px solid black;">盘长</td><td style="border: 1px solid black;" >起点塔号</td>
...
<script type="text/javascript" src="<%=basePath%>pages/material/partsExplain.js"></script>
