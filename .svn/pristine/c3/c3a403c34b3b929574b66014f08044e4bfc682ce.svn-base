...
/*/RiverSystemView/pdf/1001.pdf*/

var riverNo = getQuery("riverNo",window.location.href);

var DEFAULT_URL = 'http://'+window.location.host+'/RiverSystemView/pdf/'+riverNo+'.pdf';
